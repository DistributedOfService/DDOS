...
abstract contract ABCToken is ERC20, Ownable {
    ...
    uint256 private tokenSwapForFund = 17000000 * 10**18;
    uint256 private tokenSwapForRepo = 13000000 * 10**18;
    ...
    constructor(
        ...
        _mint(deadWallet, Supply.mul(30).div(100));
        _mint(PresaleAddress, Supply.mul(40).div(100));
        _mint(LPAddress, Supply.mul(24).div(100));
        _mint(TeamAddress, Supply.mul(6).div(100));
    ...
    function _tokenTransfer(
        ...
        if (takeSwapFee) {
            uint256 fundFees = tAmount.mul(15).div(1000);
...
contract DistributedOfService is ABCToken {
    constructor()
        ABCToken(
            ...
            "Distributed  Of  Service", //Name
            "DDOS", //Symbol
            100000000000 * 10**18, //Supply
            address(0xeE9D1d5fC446816F9B6f7c68254aEFC6bA3C16Ec), //PresaleAddress
            address(0x0175457B3FC140CDF22EB70822726217145cf272), //LPAddress
            address(0x736394965B17b3c24E0EC13dda537dd3b0bD39c5), //TeamAddress
            address(0x2c58D8810cBB95F8A75D7D9fE4154CD178d14340), //FundAddress
            address(0x08b3E788005563A2346a91Cce62b261aC70F9f59), //RepoPoolAddress
